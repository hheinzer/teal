...
CASES = [
    {
        ...
        "args": [alpha],
        "file": f"bin/explosion/1D_alpha_{alpha}_00001.hdf",
...
] + [
    {
        ...
        "args": [],
        "file": "bin/explosion/2D_00001.hdf",
        "line": ((0, 0, 0), (1, 1, 0)),
    },
    {
        "label": "3D",
        ...
        "args": [],
        "file": "bin/explosion/3D_00001.hdf",
        "line": ((0, 0, 0), (1, 1, 1)),
    },
]
...
def plot(series):
    _, axs = plt.subplots(nrows=2, ncols=2, layout="constrained")
